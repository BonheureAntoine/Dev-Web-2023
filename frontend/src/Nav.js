...
import ModifyHorse  from "./components/ModifyHorse";
    ...
    return(
                <div id ='nav-bar'>
                    ...
                    <ul id="ul-nav">
                        ...
                        <li className="nav"><Link to='/modifyhorse/1' className="chevaux">Mod</Link></li>
                        {/*{ isAuthenticated &&*/}
                    ...
                    <Routes>
                        ...
                        <Route path="/modifyhorse/1" element={<ModifyHorse />} />
